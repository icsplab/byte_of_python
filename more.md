...
지금까지 앞으로 여러분이 사용하게 될 파이썬의 여러 주요한 기능들에 대해 다뤄 보았습니다. 이 챕터에서는,
...
[공식 설명서를 읽으세요](http://docs.python.org/2/reference/datamodel.html#special-method-names).
...
이 챕터에서는 좀 더 다양한 파이썬의 여러 기능에 대해 살펴보았습니다. 아직 우리가 파이썬의 모든
