 ...
 * 참고: PDF 버전에 사용된 폰트는 http://www.kopus.org/[한국출판인회의]에서 공개한 `KOPUB 돋움` 을 수정하여 사용하였습니다.
 ...
 * Notice: The font used in PDF version of the book is http://www.kopus.org/[KOPUS] Dotum,
modified to support several latin characters.
